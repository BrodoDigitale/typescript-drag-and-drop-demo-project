...
(function (AppNamespace) {
    ...
    })(ProjectStatus = AppNamespace.ProjectStatus || (AppNamespace.ProjectStatus = {}));
    class Project {
...
(function (AppNamespace) {
    ...
    class ProjectState extends State {
        ...
        addProject(title, desc, numOfPeople) {
            const newProject = new AppNamespace.Project(Math.random().toString(), title, desc, numOfPeople, AppNamespace.ProjectStatus.Active);
    ...
    class ProjectList extends Component {
        ...
        configure() {
            ...
            projectState.addListener((projects) => {
                this.assignedProjects = projects.filter((prj) => {
                    if (this.type === "active") {
                        return prj.projectStatus === AppNamespace.ProjectStatus.Active;
                    }
                    return prj.projectStatus === AppNamespace.ProjectStatus.Finished;
                });
                this.renderProjects();
            });
        }
        ...
        dropHandler(event) {
            ...
            projectState.moveProject(prjId, this.type === "active" ? AppNamespace.ProjectStatus.Active : AppNamespace.ProjectStatus.Finished);
        }
        dragLeaveHandler(_) {
